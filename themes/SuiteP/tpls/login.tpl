...
<div class="p_login">
	...
	<div class="p_login_top">
		...
		{*<a title="Work.Sm@rt.CRM" href="http://www.swhub.io">Work.Sm@rt.CRM</a>*}
        <img src="../../../custom/include/images/logo_sw.png">
    ...
    <div class="p_login_bottom">
            ...
            <a id="powered_by">&copy; Powercherged by SmartWorkingHub</a>
