            ...
            <tr>
                ...
                <td style="padding-right: 0px;" nowrap="" width="1%">
                    <div class="dashletToolSet">
                        <a href="javascript:void(0)" title="NEW" aria-label="NEW" onclick="window.open('?action=ajaxui#ajaxUILoc=index.php%3Fmodule%3D{$DASHLET_MODULE}%26action%3DEditView%26return_module%3DHome%26return_action%3Dindex', '_self'); return false;">
