...
<div class="p_login" style="background: url('../../../../custom/themes/default/sfondo.png')">

	<div style="background-color:#55688a;padding:10px 2% 10px 2%;float:left;width:100%">
		
		<a title="Work.Sm@rt.CRM" href="http://www.swhub.io">
        <img src="../../../custom/include/images/logo_sw.png"></a>
		
	</div>
    
    <div class="p_login_middle" style="background: url('../../../../custom/themes/default/sfondo.png')">
    ...
    <div id="loginform">
		...
		{sugar_translate label="WARN_BROWSER_IE_COMPATIBILITY_MODE_WARNING"}
            ...
            <input id="bigbutton" class="btn btn-lg btn-primary btn-block" type="submit"
                   ...
                   value="{sugar_translate module="Users" label="LBL_LOGIN_BUTTON_LABEL"}" style="background-color:#55688a ">
            <div id="forgotpasslink" style="cursor: pointer; display:{$DISPLAY_FORGOT_PASSWORD_FEATURE};font-weight: bold;"
                 onclick='toggleDisplay("forgot_password_dialog");'>
                <a href='javascript:void(0)' style="color:#55688a ">{sugar_translate module="Users" label="LBL_LOGIN_FORGOT_PASSWORD"}</a>
            </div>
        </form>
