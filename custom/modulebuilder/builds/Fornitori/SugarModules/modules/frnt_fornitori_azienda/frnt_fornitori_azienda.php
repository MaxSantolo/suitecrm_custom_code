...
class frnt_fornitori_azienda extends Company
{
    public $new_schema = true;
    public $module_dir = 'frnt_fornitori_azienda';
    public $object_name = 'frnt_fornitori_azienda';
    public $table_name = 'frnt_fornitori_azienda';
    ...
    public $frnt_fornitori_azienda_type;
    public $industry;
