...
class frnt_persona_fornitore extends Person
{
    public $new_schema = true;
    public $module_dir = 'frnt_persona_fornitore';
    public $object_name = 'frnt_persona_fornitore';
    public $table_name = 'frnt_persona_fornitore';
