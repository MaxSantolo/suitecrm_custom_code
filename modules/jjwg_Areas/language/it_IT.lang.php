...
$mod_strings['LBL_DATE_MODIFIED'] = 'Ultima Modifica';
...
$mod_strings['LBL_AREA_MAP'] = 'Mappa area';

$mod_strings['LBL_AREA_EDIT_TITLE'] = 'Istruzioni di creazione Area:';
$mod_strings['LBL_AREA_EDIT_DESC_1'] = 'Cliccare con il tasto sinistro sulla mappa, in senso orario, per creare i punti marcatori per l\'area.';
$mod_strings['LBL_AREA_EDIT_DESC_2'] = 'Fare clic sul primo punto marcatore per chiudere l\'area del poligono.';
$mod_strings['LBL_AREA_EDIT_RESET'] = 'Reimposta';
$mod_strings['LBL_AREA_EDIT_USE_AREA_COORDINATES'] = 'Utilizzare le coordinate dell\'Area';
$mod_strings['LBL_AREA_EDIT_COORDINATE_RESULTS'] = 'Risultati delle coordinate (lng, lat, elv):';
