...
$mod_strings = array(
    ...
    'LBL_MAILMERGE_DESC' => 'Questo flag può essere selezionato solo se hai SuiteCRM Plug-in for Microsoft® Word®.',
    ...
    'LBL_SKYPEOUT_ON_DESC' => 'Permetti agli utenti di cliccare sui numeri di telefono per chiamare con SkypeOut&reg;.. I numeri devono essere formattati correttamente. Ovvero deve esserci "+" "il codice nazione" "il numero", ad es. +1 (555) 555-1234.',
    'LBL_SKYPEOUT_ON' => 'Abilitare il click-to-call per numeri di telefono',
    'LBL_SKYPEOUT_TITLE' => 'Clicca per Chiamare',
    ...
    'NEW_LOGO_HELP' => 'Il formato del file immagine può essere .png o .jpg. L\'altezza massima è 170px, la larghezza massima è 450px. Ogni immagine caricata più grande sarà scalata a queste dimensioni. Il nome del file immagine non deve contenere spazi.',
    'NEW_LOGO_HELP_NO_SPACE' => 'Il formato del file immagine può essere .png o .jpg. L\'altezza massima è 170px, la larghezza massima è 450px. Ogni immagine caricata più grande sarà scalata a queste dimensioni. Il nome del file immagine non deve contenere spazi.',
    ...
    'SHOW_DOWNLOADS_TAB_HELP' => 'Se selezionato, il tab di Donwload apparirà nelle impostazioni dell´Utente e fornirà agli utenti l´accesso ai plug-ins di SuiteCRM e ad altri file disponibili.',
    ...
    'LBL_PDFMODULE_NAME' => 'Impostazioni PDF',
    ...
    'PDF_SMALL_HEADER_LOGO_INFO' => 'Questa immagine compare nell´intestazione predefinita nei Documenti PDF dei Reports.<br> Questa immagine appare anche nell´angolo in alto a sinistra dell´applicazione SuiteCRM.',
    ...
    'LBL_STATUS_FONT_SUCCESS' => 'Operazione avvenuta con successo : Il carattere è stato aggiunto a SuiteCRM.',
